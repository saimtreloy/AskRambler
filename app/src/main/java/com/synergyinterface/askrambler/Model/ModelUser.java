...
public class ModelUser {
    public String user_id, nationality, full_name, email, password, agreement, status, roll, first_name, last_name, gander, address, city, zip, state, country,
